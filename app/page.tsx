  ...
  return (
    <main>
      ...
      <ScrollExpandMedia
        ...
        date={
          heroSubtitle ? (
            <ShimmerText className="text-sm sm:text-base md:text-lg font-medium text-white md:text-gray-900 text-center whitespace-normal md:whitespace-nowrap" duration={2.5} delay={1}>
              {heroSubtitle}
            </ShimmerText>
          ) : (
            <ShimmerText className="text-sm sm:text-base md:text-lg font-medium text-white md:text-gray-900 text-center whitespace-normal md:whitespace-nowrap" duration={2.5} delay={1}>
